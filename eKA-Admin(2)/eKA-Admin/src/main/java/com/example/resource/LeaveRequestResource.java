...
///leave approve api
	public ResponseEntity<CommonApiResponse> approveLeave(String empnumber) {
	  CommonApiResponse response = new CommonApiResponse();
	...
	public ResponseEntity<CommonApiResponse> rejectLeave(String empnumber) {
        CommonApiResponse response = new CommonApiResponse();
  ...
  //api for findall pending leaves
	...
	public ResponseEntity<UserResponseDto>findempleavesrequests(String empnumber){
		UserResponseDto response = new UserResponseDto();
