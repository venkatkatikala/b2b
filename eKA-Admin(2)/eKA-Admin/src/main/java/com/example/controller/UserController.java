...
//fetch all members in the organization api
   ...
   //employee registration api
    ...
    public ResponseEntity<CommonApiResponse>updateemployee(@RequestParam String name,@RequestParam String mobileno,@RequestParam String email){
    ...
    public ResponseEntity<UserResponseDto>findbyposition(@RequestParam String position){
    	return resource.findbyposition(position);
    }
    ...
    public ResponseEntity<CommonApiResponse>updatePassword(@RequestBody UpdatePasswordDto dto){
    	return resource.updatePassword(dto);
    }
}